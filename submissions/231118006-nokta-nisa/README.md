...
> [!IMPORTANT]
> 📹 [NisaDot — 60sn Demo Video](https://youtube.com/shorts/PLACEHOLDER)
>
> *Video, uygulamanın temel akışını gösterir: fikir girişi → AI soruları → spec üretimi*
...
- **AI Engine:** Google Gemini Pro API seçildi (ücretsiz tier yeterli, Türkçe dil desteği güçlü).
...
| Tool | Kullanım Amacı |
|------|---------------|
| Gemini (Antigravity) | Kod geliştirme, hata çözme, mimari tavsiye |
| Google Gemini Pro API | Uygulama içi AI motoru (soru üretimi + spec generation) |
